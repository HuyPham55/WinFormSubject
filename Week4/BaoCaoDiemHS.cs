...
namespace Week4 {
    ...
    public class BaoCaoDiemHS : ReportClass {
    ...
    public class CachedBaoCaoDiemHS : Component, ICachedReport {
        
        public CachedBaoCaoDiemHS() {
        }
